...
class CRUDGenerator(Generic[T], APIRouter, ABC):
    ...
    def __init__(
        ...
        get_one_resp_model: Type[T] = None,
        **kwargs: Any,
    ) -> None:
        ...
        if get_all_route:
            self._add_api_route(
                ...
                self._get_all(),
                methods=["GET"],
                response_model=Optional[List[get_one_resp_model if get_one_resp_model else self.schema]],  # type: ignore
                summary="Get All",
        ...
        if get_one_route:
            self._add_api_route(
                ...
                self._get_one(),
                methods=["GET"],
                response_model=get_one_resp_model if get_one_resp_model else self.schema,
                summary="Get One",
